...
public class HelloController {
    ...
    @ApiResponses(
            value = {
                ...
                @ApiResponse(
                        responseCode = "404",
                        description = "Not Found Hello by id.",
                        content = @Content(schema = @Schema(implementation = ApiResult.class))),
                @ApiResponse(
                        responseCode = "500",
                        description = "Unexpected exception occurred.",
    ...
    @PostMapping("/{id}")
    public ApiResult<HelloUpdateRspDto> update(
            @PathVariable Long id, @RequestBody HelloUpdateReqDto reqDto) {
