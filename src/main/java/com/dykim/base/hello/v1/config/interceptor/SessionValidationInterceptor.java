...
public class SessionValidationInterceptor implements HandlerInterceptor {
    ...
    private final List<String> byPassUrls = List.of("/hello/v1");
...
//        }
        ...
        final var TMP_DEBOUNCE_URI = "/hello/v1/helloPrintDebounce";
        ...
        final var TMP_VALIDATION_URI = "/hello/v1/validSession";
