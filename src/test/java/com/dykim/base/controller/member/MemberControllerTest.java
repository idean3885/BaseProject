package com.dykim.base.controller.member;
...
class MemberControllerTest {
    ...
    @Order(1)
    @Test
    void insert_return_MemberInsertRspDto() throws Exception {
        // given
        var reqDto =
    ...
    @Order(2)
    @Test
    void insert_with_invalid_mbrEml_throw_MethodArgumentNotValidException() throws Exception {
        // given
        var reqDto =
                MemberInsertReqDto.builder()
    ...
    @Order(3)
    @Test
    void insert_with_null_mbrPswd_throw_MethodArgumentNotValidException() throws Exception {
        // given
        var reqDto =
                MemberInsertReqDto.builder()
    ...
    @Order(4)
    @Test
    void insert_with_blank_mbrPswd_throw_MethodArgumentNotValidException() throws Exception {
        // given
        var reqDto =
                MemberInsertReqDto.builder()
                        .email("valid@email.com")
    ...
    @Order(5)
    @Test
    void insert_with_null_mbrNm_throw_MethodArgumentNotValidException() throws Exception {
        // given
        var reqDto =
                MemberInsertReqDto.builder()
                        .email("valid@email.com")
    ...
    @Order(6)
    @Test
    void insert_with_blank_mbrNm_throw_MethodArgumentNotValidException() throws Exception {
        // given
        var reqDto =
                MemberInsertReqDto.builder()
                        .email("valid@email.com")
    ...
    @Order(7)
    @Test
    void insert_with_11_over_mbrTelno_throw_MethodArgumentNotValidException() throws Exception {
        // given
        var reqDto =
                MemberInsertReqDto.builder()
                        .email("valid@email.com")
    ...
    @Order(8)
    @Test
    void insert_exists_mbrEml_useYn_Y_throw_AlreadyExistsException() throws Exception {
        // given
        var reqDto =
                MemberInsertReqDto.builder()
                        .email("valid@email.com")
    ...
    @Order(9)
    @Test
    void select_return_MemberSelectRspDto() throws Exception {
        // given
        var member =
                Member.builder()
                        .email("valid@email.com")
    ...
    @Order(10)
    @Test
    void select_with_invalid_mbrId_type_throw_MethodArgumentTypeMismatchException() throws Exception {
        // given
    ...
    @Order(11)
    @Test
    void selectList_return_MemberSelectListRspDto() throws Exception {
        // given
    ...
    @Order(12)
    @Test
    void update_return_MemberUpdateRspDto() throws Exception {
        // given
        var member =
                Member.builder()
                        .email("valid@email.com")
    ...
    @Order(13)
    @Test
    void delete_return_MemberDeleteRspDto() throws Exception {
        // given
        var member =
                Member.builder()
                        .email("valid@email.com")
    ...
    @Order(14)
    @Test
    void delete_with_not_found_member_throw_EntityNotFoundException() throws Exception {
        // given
