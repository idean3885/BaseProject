...
public class HelloControllerTest {
    ...
    public void insert_with_invalid_email_throw_MethodArgumentNotValidException() throws Exception {
        // given
        var helloInsertReqDto = HelloInsertReqDto.builder().email("email").name("name").build();
        var reqJson =
    ...
    public void insert_with_empty_name_throw_MethodArgumentNotValidException() throws Exception {
        // given
        var helloInsertReqDto = HelloInsertReqDto.builder().email("email@base.com").build();
        var reqJson =
                objectMapper.writerWithDefaultPrettyPrinter().writeValueAsString(helloInsertReqDto);
    ...
    @Order(6)
    @Test
    public void insert_with_invalid_birthday_format_throw_HttpMessageNotReadableException()
            throws Exception {
        // given
    ...
    @Order(7)
    @Test
    public void insert_with_invalid_yyyyMMddHHmmssSSS_format_throw_HttpMessageNotReadableException()
            throws Exception {
        // given
        var map = new HashMap<String, String>();
    ...
    @Order(9)
    @Test
    public void find_with_invalid_id_type_throw_MethodArgumentTypeMismatchException()
            throws Exception {
        // given
    ...
    public void findList_return_HelloFindListRspDto() throws Exception {
        ...
        given(helloRepository.findAllByName(sameSaveHello.getName()))
    ...
    public void update_return_HelloUpdateRspDto() throws Exception {
        ...
        var reqDto = HelloUpdateReqDto.builder().name("name").birthday(birthday).build();
        var reqJson = objectMapper.writerWithDefaultPrettyPrinter().writeValueAsString(reqDto);
        final var ANY_HELLO_ID = 1;
